...
(2, 'Grain', 'grain', ' Ton', TRUE, FALSE, ''),
(2, 'Fruit', 'fruit', ' Ton', TRUE, FALSE, ''),
(2, 'Vegetables', 'vegetables', ' Ton', TRUE, FALSE, ''),
(2, 'Livestock', 'livestock', ' Ton', TRUE, FALSE, ''),
(2, 'Fish', 'fish', ' Ton', TRUE, FALSE, ''),
(3, 'Coffee', 'coffee', ' Ton', TRUE, TRUE, ''),
(3, 'Tea', 'tea', ' Ton', TRUE, TRUE, ''),
(3, 'Cannabis', 'cannabis', ' Ton', TRUE, TRUE, ''),
(3, 'Alcohol', 'alcohol', ' Ton', TRUE, TRUE, ''),
(3, 'Tobacco', 'tobacco', ' Ton', TRUE, TRUE, ''),
(4, 'Timber', 'timber', ' Ton', TRUE, FALSE, ''),
(4, 'Fiber', 'fiber', ' Ton', TRUE, FALSE, ''),
(4, 'Ore', 'ore', ' Ton', TRUE, FALSE, ''),
(5, 'Energy', 'energy', 'MW', FALSE, FALSE, ''),
(5, 'Biofuel', 'biofuel', ' Ton', TRUE, FALSE, ''),
(5, 'Coal', 'coal', ' Ton', TRUE, FALSE, ''),
(5, 'Gas', 'gas', 'Tcf', TRUE, FALSE, ''),
(5, 'Oil', 'oil', 'MMb/d', TRUE, FALSE, ''),
(5, 'Uranium', 'uranium', ' Ton', TRUE, FALSE, ''),
(6, 'Silver', 'silver', ' Ton', TRUE, TRUE, ''),
(6, 'Gold', 'gold', ' Ton', TRUE, TRUE, ''),
(6, 'Platinum', 'platinum', ' Ton', TRUE, TRUE, ''),
(6, 'Gemstones', 'gemstones', 'CT', TRUE, TRUE, ''),
(7, 'Iron', 'iron', 'MegaTon', TRUE, FALSE, ''),
(7, 'Copper', 'copper', 'MegaTon', TRUE, FALSE, ''),
(7, 'Zinc', 'zinc', 'MegaTon', TRUE, FALSE, ''),
(7, 'Aluminum', 'aluminum', 'MegaTon', TRUE, FALSE, ''),
(7, 'Nickle', 'nickle', 'MegaTon', TRUE, FALSE, ''),
(8, 'Merchandise', 'merchandise', ' Shipments', TRUE, FALSE, ''),
(8, 'Chemicals', 'chemicals', 'Kl', TRUE, FALSE, ''),
(8, 'Steel', 'steel', 'MegaTon', TRUE, FALSE, ''),
(8, 'Electronics', 'electronics', ' Shipments', TRUE, FALSE, ''),
(9, 'Shipping Ports', 'port', '', TRUE, FALSE, ''),
(9, 'Machinery', 'machinery', ' Shipments', TRUE, FALSE, ''),
(9, 'Automotive', 'automotive', ' Shipments', TRUE, FALSE, ''),
(9, 'Aerospace', 'aerospace', ' Shipments', TRUE, FALSE, ''),
(10, 'Education', 'education', '', FALSE, FALSE, ''),
(10, 'Software', 'software', '', TRUE, FALSE, ''),
(10, 'Healthcare', 'healthcare', '', FALSE, FALSE, ''),
(10, 'Engineering', 'engineering', '', TRUE, FALSE, '');
