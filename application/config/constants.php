...
DEFINE('CITY_CASH_CROPS_COST', 1);
DEFINE('METRO_CASH_CROPS_COST', 3);
DEFINE('TOWN_ENERGY_COST', 1);
DEFINE('CITY_ENERGY_COST', 3);
DEFINE('METRO_ENERGY_COST', 5);
DEFINE('TOWN_MERCHANDISE_COST', 0);
DEFINE('CITY_MERCHANDISE_COST', 1);
DEFINE('METRO_MERCHANDISE_COST', 3);
DEFINE('TOWN_STEEL_COST', 0);
DEFINE('CITY_STEEL_COST', 0);
DEFINE('METRO_STEEL_COST', 1);
DEFINE('TOWN_HEALTHCARE_COST', 0);
DEFINE('CITY_HEALTHCARE_COST', 0);
DEFINE('METRO_HEALTHCARE_COST', 1);
DEFINE('FEDERAL_CASH_COST', 10);
DEFINE('BASE_CASH_COST', 10);
DEFINE('EDUCATION_CASH_COST', 10);
DEFINE('HEALTHCARE_CASH_COST', 10);
// Corruption
DEFINE('TILES_PER_CORRUPTION_PERCENT', 5);
// Population
DEFINE('TOWN_POPULATION_INCREMENT', 1);
DEFINE('CITY_POPULATION_INCREMENT', 5);
DEFINE('METRO_POPULATION_INCREMENT', 25);
