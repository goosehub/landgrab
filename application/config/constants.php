...
// Population
DEFINE('TOWN_POPULATION_INCREMENT', 100);
DEFINE('CITY_POPULATION_INCREMENT', 100);
DEFINE('METRO_POPULATION_INCREMENT', 100);
...
define('DEMOCRACY_SOCIALISM_MAX_SUPPORT', 400);
define('OLIGARCHY_SOCIALISM_MAX_SUPPORT', 300);
...
DEFINE('GRAIN_DEFAULT', 1);
DEFINE('CASH_DEFAULT', 30);
DEFINE('SUPPORT_DEFAULT', 75);
