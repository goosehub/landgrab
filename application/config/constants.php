...
DEFINE('INFANTRY_COST', 100);
DEFINE('INFANTRY_COLOR', 'AA3939');
DEFINE('INFANTRY_CHARACTER', 'I');
DEFINE('GUERRILLA_COST', 50);
DEFINE('GUERRILLA_COLOR', '228B22');
DEFINE('GUERRILLA_CHARACTER', 'G');
DEFINE('COMMANDOS_COST', 200);
DEFINE('COMMANDOS_COLOR', 'FFA500');
DEFINE('COMMANDOS_CHARACTER', 'C');
